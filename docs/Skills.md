...
The LQR Q/R and reference-bias sweep is not a global optimal-control result. It
...
- LQR synthesis must use explicit local speed bins and must not depend on optimizer CSV output or an implicit global 6.5 m/s trim target.
