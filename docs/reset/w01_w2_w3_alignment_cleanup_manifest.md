...
below are superseded by the current robust R5 -> R7 -> R8 -> R10 -> R11
contract in `docs/Glider_Control_Project_Plan.md`, with R9 retained only as internal preflight/ablation.
