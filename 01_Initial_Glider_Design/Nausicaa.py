...
# target turn radius
R_target = op_point.velocity ** 2 / (g * np.tan(phi_rad))
...
for airfoil in airfoils.values():
    airfoil.generate_polars(
        cache_filename=f"A_cache/{airfoil.name}.json",
...
if __name__ == "__main__":
    ...
    if make_plots:
        ...
        p.show_plot(
            tight_layout=False,
            savefig="B_figures/three_view.png",
        )
        ...
        p.show_plot(savefig="B_figures/mass_budget.png")
        ...
        fig.tight_layout()
        fig.savefig(
            "B_figures/thermal_with_rollin_trajectory.png",
            dpi=300,
            bbox_inches="tight",
        )
        ...
        fig_ts.tight_layout()
        fig_ts.savefig(
            "B_figures/rollrate_and_aileron_vs_time.png",
            dpi=300,
            bbox_inches="tight",
