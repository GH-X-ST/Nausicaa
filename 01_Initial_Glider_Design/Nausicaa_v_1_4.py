...
### Wing
wing_span               = opti.variable(init_guess = 0.7, lower_bound = 0.1, upper_bound = 1.2)
...
if __name__ == '__main__': # only run this block when the file is executed directly
    ...
    check_var("wing_span",         wing_span,                  lb = 0.3,    ub = 1.2)
    ...
    # check_var("S_ht",              S_ht,                       lb = 1e-3,    ub = 0.15 * wing.area())
    check_var("l_ht",              l_ht,                       lb = 0.2,    ub = 1.5)

    # check_var("S_vt",              S_ht,                       lb = 1e-3,    ub = 0.08 * wing.area())
