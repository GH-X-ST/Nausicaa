"""
Plot four-fan annular-GP heat maps using the appendix figure style.
...
using the z###_annular_gp_mean sheets written by four_fan_annular_gp.py.
"""
...
def main() -> None:
    ...
    for sh in SHEETS:
        ...
        out_png = OUT_DIR / f"{sh}_four_annular_gp_heatmap_main_appendix.png"
