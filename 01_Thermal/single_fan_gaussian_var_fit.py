...
This script reads output from single_fan_gaussian_var.py
(B_results/single_var_params.xlsx), interpolates fitted parameters
...
OUT_XLSX_PATH = Path("B_results/single_var_params_pchip.xlsx")
