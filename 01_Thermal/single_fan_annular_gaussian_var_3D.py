...
precomputed PCHIP table written by single_fan_annular_gaussian_var_fit.py.

Input is read from single_fan_annular_gaussian_var_fit.py output
(by default: B_results/single_annular_var_params_pchip.xls/.xlsx).
"""
...
PARAMS_XLSX = Path("B_results/single_annular_var_params_pchip.xls")
PARAMS_SHEET = "single_annular_var_pchip"

OUT_DIR = Path("A_figures/Single_Fan_Annular_Gaussian_Var")
OUT_3D_NAME = "single_annular_gaussian_var_3d.png"
...
# Typography (match single_fan_annular_gaussian_var_heat_map_main.py)
