"""
Compute error metrics for the single-fan plain Gaussian model.
...
FIT_XLSX_PATH = Path("B_results/single_var_params_pchip.xlsx")
FIT_SHEET_NAME = "single_var_pchip"

# Output is written to a new/replaced sheet in the fit workbook.
OUT_XLSX_PATH = Path("B_results/single_var_analysis.xlsx")
OUT_SHEET_NAME = "single_var_analysis"
