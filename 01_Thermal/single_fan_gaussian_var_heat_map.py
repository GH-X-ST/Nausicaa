...
B_results/single_var_params.xlsx and used to generate a continuous model
...
# Gaussian-parameter tables are fitted-model inputs and remain separate from measured workbook grids.
...
def main():
    ...
    for sh in SHEETS:
        ...
        out_png = OUT_DIR / f"{sh}_single_gaussian_var_heatmap.png"
