...
`metrics/neutral_aero_residual_joint_sweep_pareto.csv`, and
`metrics/neutral_aero_residual_joint_sweep_selected.csv` for compact joint
sweep trade-offs, and `metrics/neutral_aero_residual_stage_replay_errors.csv`
for train/held-out attached, transition, and post-stall replay MAE.
