...
- Residual memory policy: `outer_loop_baseline_shielded_recency_safe_exploration_memory_v1_3` applies capped, recency-weighted candidate-path residual memory and shielded uncertainty exploration after viability filtering.
...
- `hard_failure_rate_within_stage_profile`: `True` observed `0.05` required `0.2`
...
- `safe_success_rate_within_stage_profile`: `True` observed `0.95` required `0.2`
- `terminal_or_lift_capture_within_stage_profile`: `True` observed `1.0` required `0.3`
- `selected_primitive_family_count_diagnostic`: `True` observed `6` required `diagnostic_only_not_a_governor_pass_gate`
- `selected_variant_count_diagnostic`: `True` observed `35` required `diagnostic_only_not_a_governor_pass_gate`
