...
- Residual memory policy: `outer_loop_candidate_path_residual_memory_v1_0` applies a capped, confidence-gated correction along each candidate primitive's predicted path after viability filtering.
...
- `selected_variant_count_ge_10`: `True` observed `16` required `10`
