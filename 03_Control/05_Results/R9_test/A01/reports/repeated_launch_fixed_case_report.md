...
- `hard_failure_rate_within_stage_profile`: `False` observed `0.3333333333333333` required `0.2`
...
- `safe_success_rate_within_stage_profile`: `True` observed `0.6666666666666666` required `0.2`
...
- `selected_variant_count_ge_10`: `True` observed `13` required `10`
