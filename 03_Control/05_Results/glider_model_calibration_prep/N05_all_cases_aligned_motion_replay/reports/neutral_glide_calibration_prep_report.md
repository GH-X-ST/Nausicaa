...
- output root: `C:/Users/GH-X-ST/OneDrive - Imperial College London/Year 4/Final Year Project/01 - Github/Nausicaa/03_Control/05_Results/glider_model_calibration_prep/N05_all_cases_aligned_motion_replay`
- generated: `2026-06-03T17:00:41`
- valid throws: `170`
...
- mean replay dx residual: `-0.3696233562` m
- mean replay dy residual: `-0.2911336129` m
- mean replay altitude-loss residual: `-0.1801141327` m
- mean replay sink-rate residual: `-0.1569604025` m/s
- replay dy residual MAE: `0.6867447642` m
...
- alignment window: `0.15` s
- aligned replay rows: `170`
- successful aligned replay rows: `170`
- mean aligned dx residual: `-0.04806880885` m
- mean aligned dy residual: `-0.261700227` m
- mean aligned altitude-loss residual: `-0.1838085794` m
- mean aligned sink-rate residual: `-0.1730239857` m/s
- aligned dy residual MAE: `0.6226415072` m
