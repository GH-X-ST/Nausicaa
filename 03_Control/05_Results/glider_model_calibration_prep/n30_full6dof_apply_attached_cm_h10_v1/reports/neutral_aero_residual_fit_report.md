...
```powershell
python 03_Control/02_Inner_Loop/run_fit_neutral_aero_residual_calibration.py --session-root 04_Flight_Test\05_Results\cal\n30 --run-label n30_full6dof_apply_attached_cm_h10_v1 --heldout-count 10 --heldout-seed 606 --alignment-window-s 0.1 --derivative-window-s 0.04 --replay-dt-s 0.005 --ridge-lambda 0.001 --min-speed-m-s 1.5 --workers 8 --apply-attached-cm-bias --fit-post-stall-damping
```
...
- candidate train pitch MAE: `17.151` deg
- baseline held-out pitch MAE: `18.886` deg
- candidate held-out pitch MAE: `18.690` deg
- baseline held-out altitude-loss MAE: `0.3265` m
- candidate held-out altitude-loss MAE: `0.0952` m
- baseline held-out dx MAE: `0.7509` m
- candidate held-out dx MAE: `0.2944` m
...
- train/attached: samples `116`, throws `14`
  ...
  - candidate dx/dy/alt/sink/roll/pitch/yaw MAE: `0.097` m, `0.009` m, `0.011` m, `0.294` m/s, `0.66` deg, `2.18` deg, `0.19` deg
- train/transition: samples `532`, throws `20`
  ...
  - candidate dx/dy/alt/sink/roll/pitch/yaw MAE: `0.080` m, `0.081` m, `0.063` m, `0.339` m/s, `3.64` deg, `3.71` deg, `1.66` deg
- train/post_stall: samples `2851`, throws `20`
  ...
  - candidate dx/dy/alt/sink/roll/pitch/yaw MAE: `0.246` m, `0.356` m, `0.202` m, `0.329` m/s, `27.80` deg, `9.48` deg, `17.69` deg
- heldout/attached: samples `65`, throws `8`
  ...
  - candidate dx/dy/alt/sink/roll/pitch/yaw MAE: `0.019` m, `0.011` m, `0.010` m, `0.246` m/s, `0.55` deg, `1.42` deg, `0.28` deg
- heldout/transition: samples `265`, throws `10`
  ...
  - candidate dx/dy/alt/sink/roll/pitch/yaw MAE: `0.107` m, `0.221` m, `0.069` m, `0.305` m/s, `10.31` deg, `3.99` deg, `2.90` deg
- heldout/post_stall: samples `1420`, throws `10`
  ...
  - candidate dx/dy/alt/sink/roll/pitch/yaw MAE: `0.246` m, `0.530` m, `0.136` m, `0.229` m/s, `30.66` deg, `9.57` deg, `15.90` deg
