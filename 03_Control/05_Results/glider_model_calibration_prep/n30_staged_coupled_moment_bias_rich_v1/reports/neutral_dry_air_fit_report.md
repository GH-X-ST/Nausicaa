...
```powershell
python 03_Control/02_Inner_Loop/run_fit_neutral_dry_air_calibration.py --session-root 04_Flight_Test\05_Results\cal\n30 --run-label n30_staged_coupled_moment_bias_rich_v1 --heldout-count 16 --heldout-seed 606 --replay-dt-s 0.005 --alignment-window-s 0.1 --workers 8 --coordinate-passes 3 --fit-workflow staged --longitudinal-grid-profile coupled --fit-aero-moment-bias --no-fit-neutral-trim
```
...
- train count: `64`
- train dx MAE: `0.3488` m
- train dy MAE: `0.4079` m
- train altitude-loss MAE: `0.1743` m
- train sink-rate MAE: `0.1682` m/s
- train final roll MAE: `15.269` deg
- train final pitch MAE: `38.616` deg
- train final yaw MAE: `16.687` deg
- held-out count: `16`
- held-out dx MAE: `0.4423` m
- held-out dy MAE: `0.4680` m
- held-out altitude-loss MAE: `0.1723` m
- held-out sink-rate MAE: `0.1651` m/s
- held-out final roll MAE: `12.677` deg
- held-out final pitch MAE: `36.228` deg
- held-out final yaw MAE: `10.555` deg
