...
- candidate train pitch MAE: `20.191` deg
- baseline held-out pitch MAE: `15.644` deg
- candidate held-out pitch MAE: `15.644` deg
- baseline held-out altitude-loss MAE: `0.9277` m
- candidate held-out altitude-loss MAE: `0.9277` m
- baseline held-out dx MAE: `0.8684` m
- candidate held-out dx MAE: `0.8684` m
...
- train/attached: samples `317`, throws `10`
  ...
  - candidate dx/dy/alt/sink/roll/pitch/yaw MAE: `0.171` m, `0.236` m, `0.196` m, `0.330` m/s, `4.46` deg, `7.68` deg, `3.08` deg
- train/transition: samples `1045`, throws `10`
  ...
  - candidate dx/dy/alt/sink/roll/pitch/yaw MAE: `0.364` m, `0.528` m, `0.556` m, `0.786` m/s, `5.49` deg, `22.27` deg, `6.66` deg
- train/post_stall: samples `339`, throws `6`
  ...
  - candidate dx/dy/alt/sink/roll/pitch/yaw MAE: `0.739` m, `0.995` m, `0.763` m, `0.923` m/s, `4.31` deg, `25.96` deg, `8.10` deg
- heldout/attached: samples `257`, throws `10`
  ...
  - candidate dx/dy/alt/sink/roll/pitch/yaw MAE: `0.241` m, `0.421` m, `0.263` m, `0.392` m/s, `5.41` deg, `7.19` deg, `2.80` deg
- heldout/transition: samples `1234`, throws `10`
  ...
  - candidate dx/dy/alt/sink/roll/pitch/yaw MAE: `0.363` m, `0.636` m, `0.404` m, `0.558` m/s, `12.57` deg, `15.86` deg, `8.90` deg
- heldout/post_stall: samples `172`, throws `4`
  ...
  - candidate dx/dy/alt/sink/roll/pitch/yaw MAE: `0.420` m, `0.782` m, `0.450` m, `0.653` m/s, `15.39` deg, `19.48` deg, `5.35` deg
