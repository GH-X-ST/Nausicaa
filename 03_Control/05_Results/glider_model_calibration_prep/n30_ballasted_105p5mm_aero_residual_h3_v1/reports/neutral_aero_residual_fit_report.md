...
```powershell
python 03_Control/02_Inner_Loop/run_fit_neutral_aero_residual_calibration.py --session-root 04_Flight_Test\05_Results\cal\n30\20260604_185934 --run-label n30_ballasted_105p5mm_aero_residual_h3_v1 --heldout-count 3 --heldout-seed 606 --alignment-window-s 0.1 --derivative-window-s 0.04 --replay-dt-s 0.005 --ridge-lambda 0.001 --min-speed-m-s 1.5 --workers 8 --no-apply-attached-cm-bias --fit-post-stall-damping --fit-lateral-surfaces
```
...
- candidate train pitch MAE: `20.304` deg
- baseline held-out pitch MAE: `14.376` deg
- candidate held-out pitch MAE: `16.674` deg
- baseline held-out altitude-loss MAE: `0.8964` m
- candidate held-out altitude-loss MAE: `0.8860` m
- baseline held-out dx MAE: `1.3825` m
- candidate held-out dx MAE: `1.3939` m
...
- train/attached: samples `201`, throws `7`
  ...
  - candidate dx/dy/alt/sink/roll/pitch/yaw MAE: `0.243` m, `0.567` m, `0.278` m, `0.401` m/s, `10.61` deg, `9.51` deg, `6.64` deg
- train/transition: samples `690`, throws `7`
  ...
  - candidate dx/dy/alt/sink/roll/pitch/yaw MAE: `0.271` m, `0.585` m, `0.448` m, `0.640` m/s, `8.76` deg, `18.76` deg, `7.70` deg
- train/post_stall: samples `112`, throws `2`
  ...
  - candidate dx/dy/alt/sink/roll/pitch/yaw MAE: `0.162` m, `0.554` m, `0.141` m, `0.259` m/s, `10.21` deg, `9.72` deg, `8.26` deg
...
- heldout/transition: samples `344`, throws `3`
  ...
  - candidate dx/dy/alt/sink/roll/pitch/yaw MAE: `0.796` m, `0.407` m, `0.425` m, `0.711` m/s, `9.99` deg, `12.42` deg, `7.99` deg
