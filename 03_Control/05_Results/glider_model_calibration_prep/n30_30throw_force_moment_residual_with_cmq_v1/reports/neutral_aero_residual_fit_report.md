...
```powershell
python 03_Control/02_Inner_Loop/run_fit_neutral_aero_residual_calibration.py --session-root 04_Flight_Test\05_Results\cal\n30 --run-label n30_30throw_force_moment_residual_with_cmq_v1 --heldout-count 6 --heldout-seed 606 --alignment-window-s 0.1 --derivative-window-s 0.04 --replay-dt-s 0.005 --ridge-lambda 0.001 --min-speed-m-s 1.5 --workers 8 --no-apply-attached-cm-bias --fit-post-stall-damping
```
...
- fit status: `ok`
- sample count: `4247`
- used sample count: `4183`
- fit MAE in Cm: `0.04666`
- attached Cm residual: `0.0267903`
- transition Cm residual: `0.0340274`
- post-stall CL residual: `0.0605886`
- post-stall CD residual: `-0.0590421`
- post-stall Cm residual: `-0.0596188`
- post-stall Cmq residual: `4.70076`

## Replay Validation

- baseline train pitch MAE: `17.638` deg
- candidate train pitch MAE: `14.659` deg
- baseline held-out pitch MAE: `15.825` deg
- candidate held-out pitch MAE: `14.280` deg
- baseline held-out altitude-loss MAE: `0.4567` m
- candidate held-out altitude-loss MAE: `0.5674` m
- baseline held-out dx MAE: `0.9731` m
- candidate held-out dx MAE: `1.3427` m

## Candidate Parameters

- baseline post-stall CL residual: `0`
- candidate post-stall CL residual: `0.0605886`
- baseline post-stall CD residual: `0`
- candidate post-stall CD residual: `-0.0590421`
- baseline post-stall Cm: `0`
- candidate post-stall Cm: `-0.0596188`
