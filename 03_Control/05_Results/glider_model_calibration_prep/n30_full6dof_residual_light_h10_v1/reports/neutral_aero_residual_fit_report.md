...
```powershell
python 03_Control/02_Inner_Loop/run_fit_neutral_aero_residual_calibration.py --session-root 04_Flight_Test\05_Results\cal\n30 --run-label n30_full6dof_residual_light_h10_v1 --heldout-count 10 --heldout-seed 606 --alignment-window-s 0.1 --derivative-window-s 0.04 --replay-dt-s 0.005 --ridge-lambda 0.001 --min-speed-m-s 1.5 --workers 8 --no-apply-attached-cm-bias --fit-post-stall-damping
```
...
- candidate train pitch MAE: `12.014` deg
- baseline held-out pitch MAE: `18.886` deg
- candidate held-out pitch MAE: `21.195` deg
- baseline held-out altitude-loss MAE: `0.3265` m
- candidate held-out altitude-loss MAE: `0.2659` m
- baseline held-out dx MAE: `0.7509` m
- candidate held-out dx MAE: `0.7563` m
...
- train/transition: samples `532`, throws `20`
  ...
  - candidate dx/dy/alt/sink/roll/pitch/yaw MAE: `0.083` m, `0.080` m, `0.066` m, `0.345` m/s, `3.58` deg, `4.81` deg, `1.49` deg
- train/post_stall: samples `2851`, throws `20`
  ...
  - candidate dx/dy/alt/sink/roll/pitch/yaw MAE: `0.332` m, `0.350` m, `0.212` m, `0.345` m/s, `26.74` deg, `11.42` deg, `17.38` deg
...
- heldout/transition: samples `265`, throws `10`
  ...
  - candidate dx/dy/alt/sink/roll/pitch/yaw MAE: `0.205` m, `0.224` m, `0.174` m, `0.446` m/s, `7.10` deg, `10.01` deg, `3.02` deg
- heldout/post_stall: samples `1420`, throws `10`
  ...
  - candidate dx/dy/alt/sink/roll/pitch/yaw MAE: `0.407` m, `0.540` m, `0.209` m, `0.320` m/s, `28.29` deg, `13.58` deg, `15.27` deg
