...
- staged decisions:
  ...
  - `stage2_transition_cm` `transition_pitch_moment`: accepted `False`, held-out pitch `7.778` -> `7.668` deg, altitude-loss `0.3842` -> `0.3814` m
  - `stage3_post_stall_cm` `post_stall_pitch_moment`: accepted `False`, held-out pitch `7.778` -> `7.716` deg, altitude-loss `0.3842` -> `0.3897` m
  - `stage4_post_stall_cmq` `post_stall_pitch_damping`: accepted `False`, held-out pitch `7.778` -> `7.600` deg, altitude-loss `0.3842` -> `0.4416` m
  - `stage5_transition_blend` `transition_blend_start_full`: accepted `False`, held-out pitch `7.778` -> `5.427` deg, altitude-loss `0.3842` -> `0.3463` m
  - `stage6_post_stall_lift_drag` `post_stall_lift_drag`: accepted `False`, held-out pitch `7.778` -> `8.263` deg, altitude-loss `0.3842` -> `0.4209` m
...
- transition-window lateral coupling:
  ...
  - Cl: bias `0`, beta `0`, p_hat `0`, r_hat `0`
  - Cn: bias `0`, beta `0`, p_hat `0`, r_hat `0`
- lateral diagnostic held-out dy/roll/yaw MAE: `1.0452` m, `27.420` deg, `62.340` deg
...
- lateral diagnostic policy: secondary lateral diagnostic is reportable only if held-out dy, roll, and yaw improve versus the primary longitudinal candidate while dx, altitude loss, sink, and pitch do not degrade
  - dy_mae_m (lateral_improvement_required): primary `1.6290`, diagnostic `1.0452`, delta `-0.5838`, pass `True`
  - final_phi_mae_deg (lateral_improvement_required): primary `23.0022`, diagnostic `27.4200`, delta `4.4179`, pass `False`
  - final_psi_mae_deg (lateral_improvement_required): primary `26.7760`, diagnostic `62.3399`, delta `35.5639`, pass `False`
  - dx_mae_m (longitudinal_preservation_required): primary `0.4039`, diagnostic `0.5709`, delta `0.1670`, pass `False`
  - altitude_loss_mae_m (longitudinal_preservation_required): primary `0.3842`, diagnostic `0.5853`, delta `0.2011`, pass `False`
  - sink_mae_m_s (longitudinal_preservation_required): primary `0.3436`, diagnostic `0.5214`, delta `0.1778`, pass `False`
  - final_theta_mae_deg (longitudinal_preservation_required): primary `7.7780`, diagnostic `38.6324`, delta `30.8544`, pass `False`

## Replay Validation

- baseline train pitch MAE: `22.878` deg
- candidate train pitch MAE: `6.552` deg
- baseline held-out pitch MAE: `20.505` deg
- candidate held-out pitch MAE: `7.778` deg
- baseline held-out altitude-loss MAE: `1.1807` m
- candidate held-out altitude-loss MAE: `0.3842` m
- baseline held-out dx MAE: `0.9444` m
- candidate held-out dx MAE: `0.4039` m
...
- acceptance policy: primary longitudinal candidate must improve or preserve held-out dx, altitude loss, sink, and pitch MAE versus baseline_active; lateral errors are reported but not claim-bearing
  - dx_mae_m: baseline `0.9444`, candidate `0.4039`, delta `-0.5405`, pass `True`
  - altitude_loss_mae_m: baseline `1.1807`, candidate `0.3842`, delta `-0.7965`, pass `True`
  - sink_mae_m_s: baseline `1.0739`, candidate `0.3436`, delta `-0.7303`, pass `True`
  - final_theta_mae_deg: baseline `20.5054`, candidate `7.7780`, delta `-12.7274`, pass `True`
...
- train/attached: samples `2248`, throws `63`
  ...
  - candidate dx/dy/alt/sink/roll/pitch/yaw MAE: `0.153` m, `0.491` m, `0.153` m, `0.263` m/s, `8.65` deg, `4.67` deg, `8.36` deg
- train/transition: samples `7358`, throws `63`
  ...
  - candidate dx/dy/alt/sink/roll/pitch/yaw MAE: `0.190` m, `0.565` m, `0.240` m, `0.392` m/s, `13.14` deg, `8.41` deg, `11.23` deg
- train/post_stall: samples `891`, throws `19`
  ...
  - candidate dx/dy/alt/sink/roll/pitch/yaw MAE: `0.317` m, `0.917` m, `0.208` m, `0.302` m/s, `14.15` deg, `9.14` deg, `9.50` deg
- heldout/attached: samples `394`, throws `11`
  ...
  - candidate dx/dy/alt/sink/roll/pitch/yaw MAE: `0.079` m, `0.405` m, `0.094` m, `0.250` m/s, `8.78` deg, `4.22` deg, `6.65` deg
- heldout/transition: samples `1260`, throws `11`
  ...
  - candidate dx/dy/alt/sink/roll/pitch/yaw MAE: `0.180` m, `0.691` m, `0.238` m, `0.406` m/s, `17.97` deg, `6.41` deg, `13.38` deg
- heldout/post_stall: samples `251`, throws `5`
  ...
  - candidate dx/dy/alt/sink/roll/pitch/yaw MAE: `0.364` m, `0.855` m, `0.365` m, `0.537` m/s, `23.84` deg, `4.58` deg, `11.35` deg
