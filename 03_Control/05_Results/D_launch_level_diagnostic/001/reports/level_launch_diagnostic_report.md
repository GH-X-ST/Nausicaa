...
- Gate profile: `single_case_level_launch_diagnostic_expected_all_safe`
...
- `hard_failure_rate_within_stage_profile`: `False` observed `1.0` required `0.0`
...
- `safe_success_rate_within_stage_profile`: `False` observed `0.0` required `1.0`
- `terminal_or_lift_capture_within_stage_profile`: `False` observed `0.6666666666666666` required `1.0`
