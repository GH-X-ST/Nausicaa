...
- `claim_bearing_final_launch_count_positive`: `True` observed `2917` required `>0_after_expected_low_energy_dry_air_sink_exclusion`
- `expected_low_energy_dry_air_sink_labeled`: `True` observed `333` required `diagnostic_not_claim_bearing_governor_failure`
- `hard_failure_rate_within_stage_profile`: `False` observed `0.10318820706205005` required `0.01`
- `floor_or_ceiling_violation_rate_within_stage_profile`: `False` observed `0.09770311964346932` required `0.0`
- `no_viable_primitive_rate_within_stage_profile`: `False` observed `0.06307850531367844` required `0.02`
- `safe_success_rate_within_stage_profile`: `False` observed `0.8337332876242715` required `0.99`
- `terminal_or_lift_capture_within_stage_profile`: `False` observed `0.8337332876242715` required `0.9`
- `front_wall_mission_success_rate_diagnostic`: `True` observed `0.7199177236887213` required `diagnostic_only_score_target_not_current_pass_gate`
- `wrong_wall_exit_rate_diagnostic`: `True` observed `0.11930065135413095` required `diagnostic_only_penalised_by_launch_score`
- `selected_primitive_family_count_diagnostic`: `True` observed `8` required `diagnostic_only_not_a_governor_pass_gate`
- `selected_variant_count_diagnostic`: `True` observed `145` required `diagnostic_only_not_a_governor_pass_gate`
