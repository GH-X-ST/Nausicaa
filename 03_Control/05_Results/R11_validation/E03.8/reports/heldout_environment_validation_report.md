...
- `expected_low_energy_dry_air_sink_labeled`: `True` observed `419` required `diagnostic_not_claim_bearing_governor_failure`
- `hard_failure_rate_within_stage_profile`: `False` observed `0.17663421418636996` required `0.01`
- `floor_or_ceiling_violation_rate_within_stage_profile`: `False` observed `0.14464534075104313` required `0.0`
- `no_viable_primitive_rate_within_stage_profile`: `False` observed `0.07649513212795549` required `0.02`
- `safe_success_rate_within_stage_profile`: `False` observed `0.7468706536856745` required `0.99`
- `terminal_or_lift_capture_within_stage_profile`: `False` observed `0.780250347705146` required `0.9`
- `front_wall_mission_success_rate_diagnostic`: `True` observed `0.6898470097357441` required `diagnostic_only_score_target_not_current_pass_gate`
- `wrong_wall_exit_rate_diagnostic`: `True` observed `0.08205841446453407` required `diagnostic_only_penalised_by_launch_score`
- `selected_primitive_family_count_diagnostic`: `True` observed `8` required `diagnostic_only_not_a_governor_pass_gate`
- `selected_variant_count_diagnostic`: `True` observed `141` required `diagnostic_only_not_a_governor_pass_gate`
