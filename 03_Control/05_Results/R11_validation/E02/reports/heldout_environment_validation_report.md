...
- Status: `complete`
- Pass gate: `False`
- Expected final held-out launches: `400`
...
- `final_heldout_launch_count`: `True` observed `400` required `400`
...
- `launch_inflight_recovery_sequence_policy`: `True` observed `3840` required `3840`
- `claim_bearing_final_launch_count_positive`: `True` observed `320` required `>0_after_expected_low_energy_dry_air_sink_exclusion`
- `expected_low_energy_dry_air_sink_labeled`: `True` observed `0` required `diagnostic_not_claim_bearing_governor_failure`
- `hard_failure_rate_within_stage_profile`: `False` observed `0.14375` required `0.01`
- `floor_or_ceiling_violation_rate_within_stage_profile`: `False` observed `0.14375` required `0.0`
- `no_viable_primitive_rate_within_stage_profile`: `False` observed `0.065625` required `0.02`
- `safe_success_rate_within_stage_profile`: `False` observed `0.790625` required `0.99`
- `terminal_or_lift_capture_within_stage_profile`: `False` observed `0.790625` required `0.9`
- `front_wall_mission_success_rate_diagnostic`: `True` observed `0.790625` required `diagnostic_only_score_target_not_current_pass_gate`
...
- `selected_variant_count_diagnostic`: `True` observed `53` required `diagnostic_only_not_a_governor_pass_gate`
