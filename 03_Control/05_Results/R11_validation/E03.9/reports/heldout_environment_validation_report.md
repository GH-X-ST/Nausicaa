...
- `claim_bearing_final_launch_count_positive`: `True` observed `2876` required `>0_after_expected_low_energy_dry_air_sink_exclusion`
- `expected_low_energy_dry_air_sink_labeled`: `True` observed `449` required `diagnostic_not_claim_bearing_governor_failure`
- `hard_failure_rate_within_stage_profile`: `False` observed `0.07475660639777469` required `0.01`
- `floor_or_ceiling_violation_rate_within_stage_profile`: `False` observed `0.06015299026425591` required `0.0`
- `no_viable_primitive_rate_within_stage_profile`: `False` observed `0.08727399165507649` required `0.02`
- `safe_success_rate_within_stage_profile`: `False` observed `0.8379694019471489` required `0.99`
- `terminal_or_lift_capture_within_stage_profile`: `False` observed `0.8379694019471489` required `0.9`
- `front_wall_mission_success_rate_diagnostic`: `True` observed `0.8379694019471489` required `diagnostic_only_score_target_not_current_pass_gate`
- `wrong_wall_exit_rate_diagnostic`: `True` observed `0.014603616133518776` required `diagnostic_only_penalised_by_launch_score`
- `selected_primitive_family_count_diagnostic`: `True` observed `8` required `diagnostic_only_not_a_governor_pass_gate`
- `selected_variant_count_diagnostic`: `True` observed `121` required `diagnostic_only_not_a_governor_pass_gate`
