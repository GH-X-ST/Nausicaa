...
- Status: `complete`
- Pass gate: `False`
- Expected final held-out launches: `11200`
- Expected history launches: `120400`
...
- `final_heldout_launch_count`: `True` observed `11200` required `11200`
- `history_launch_count`: `True` observed `120400` required `120400`
- `library_size_case_count`: `True` observed `5` required `5`
- `policy_history_condition_count`: `True` observed `4` required `4`
- `pairing_audit`: `True` observed `560` required `560`
...
- `no_glider_latency_variation_audit`: `True` observed `560` required `560`
- `launch_inflight_recovery_sequence_policy`: `True` observed `131600` required `131600`
- `claim_bearing_final_launch_count_positive`: `True` observed `8712` required `>0_after_expected_low_energy_dry_air_sink_exclusion`
- `expected_low_energy_dry_air_sink_labeled`: `True` observed `2488` required `diagnostic_not_claim_bearing_governor_failure`
- `hard_failure_rate_within_stage_profile`: `False` observed `0.04522497704315886` required `0.01`
- `floor_or_ceiling_violation_rate_within_stage_profile`: `False` observed `0.0048209366391184574` required `0.0`
- `no_viable_primitive_rate_within_stage_profile`: `False` observed `0.10950413223140495` required `0.02`
- `safe_success_rate_within_stage_profile`: `False` observed `0.8452708907254362` required `0.99`
- `terminal_or_lift_capture_within_stage_profile`: `False` observed `0.8452708907254362` required `0.9`
- `front_wall_mission_success_rate_diagnostic`: `True` observed `0.807277318640955` required `diagnostic_only_score_target_not_current_pass_gate`
- `wrong_wall_exit_rate_diagnostic`: `True` observed `0.07633149678604224` required `diagnostic_only_penalised_by_launch_score`
- `selected_primitive_family_count_diagnostic`: `True` observed `8` required `diagnostic_only_not_a_governor_pass_gate`
- `selected_variant_count_diagnostic`: `True` observed `541` required `diagnostic_only_not_a_governor_pass_gate`
