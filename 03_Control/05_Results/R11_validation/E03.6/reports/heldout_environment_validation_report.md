...
- `claim_bearing_final_launch_count_positive`: `True` observed `2855` required `>0_after_expected_low_energy_dry_air_sink_exclusion`
- `expected_low_energy_dry_air_sink_labeled`: `True` observed `440` required `diagnostic_not_claim_bearing_governor_failure`
- `hard_failure_rate_within_stage_profile`: `False` observed `0.12924693520140104` required `0.01`
- `floor_or_ceiling_violation_rate_within_stage_profile`: `False` observed `0.10367775831873906` required `0.0`
- `no_viable_primitive_rate_within_stage_profile`: `False` observed `0.09492119089316987` required `0.02`
- `safe_success_rate_within_stage_profile`: `False` observed `0.7758318739054291` required `0.99`
- `terminal_or_lift_capture_within_stage_profile`: `False` observed `0.7758318739054291` required `0.9`
- `front_wall_mission_success_rate_diagnostic`: `True` observed `0.5029772329246935` required `diagnostic_only_score_target_not_current_pass_gate`
- `wrong_wall_exit_rate_diagnostic`: `True` observed `0.2970227670753065` required `diagnostic_only_penalised_by_launch_score`
- `selected_primitive_family_count_diagnostic`: `True` observed `8` required `diagnostic_only_not_a_governor_pass_gate`
- `selected_variant_count_diagnostic`: `True` observed `160` required `diagnostic_only_not_a_governor_pass_gate`
