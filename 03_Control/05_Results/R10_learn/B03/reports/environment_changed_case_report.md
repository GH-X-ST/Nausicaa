...
- `hard_failure_rate_within_stage_profile`: `False` observed `0.208` required `0.2`
- `floor_or_ceiling_violation_rate_within_stage_profile`: `True` observed `0.188` required `0.2`
- `no_viable_primitive_rate_within_stage_profile`: `True` observed `0.064` required `0.3`
- `safe_success_rate_within_stage_profile`: `True` observed `0.728` required `0.2`
- `terminal_or_lift_capture_within_stage_profile`: `True` observed `0.728` required `0.3`
- `front_wall_mission_success_rate_diagnostic`: `True` observed `0.692` required `diagnostic_only_score_target_not_current_pass_gate`
- `wrong_wall_exit_rate_diagnostic`: `True` observed `0.056` required `diagnostic_only_penalised_by_launch_score`
...
- `r10_learning_stage_uses_final_reject_rate_not_candidate_reject_rate`: `True` observed `0.064` required `bounded_final_no_viable_rate_plus_tuning_handoff_diagnostics`
