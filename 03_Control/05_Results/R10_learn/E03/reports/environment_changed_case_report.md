...
- R10 success claim policy: any one of `heavy_cluster`, `balanced_cluster`, or `light_cluster` must satisfy the claim-bearing stage profile; aggregate rates remain diagnostics.
...
- `hard_failure_rate_within_stage_profile`: `True` observed `0.20689655172413793` required `aggregate_diagnostic_only; blocking_R10_claim_gate_is_r10_any_deployable_cluster_claim_profile_within_stage_profile`
- `floor_or_ceiling_violation_rate_within_stage_profile`: `True` observed `0.15270935960591134` required `aggregate_diagnostic_only; blocking_R10_claim_gate_is_r10_any_deployable_cluster_claim_profile_within_stage_profile`
- `no_viable_primitive_rate_within_stage_profile`: `True` observed `0.08866995073891626` required `aggregate_diagnostic_only; blocking_R10_claim_gate_is_r10_any_deployable_cluster_claim_profile_within_stage_profile`
- `safe_success_rate_within_stage_profile`: `True` observed `0.7044334975369458` required `aggregate_diagnostic_only; blocking_R10_claim_gate_is_r10_any_deployable_cluster_claim_profile_within_stage_profile`
- `terminal_or_lift_capture_within_stage_profile`: `True` observed `0.7044334975369458` required `aggregate_diagnostic_only; blocking_R10_claim_gate_is_r10_any_deployable_cluster_claim_profile_within_stage_profile`
- `front_wall_mission_success_rate_diagnostic`: `True` observed `0.6551724137931034` required `diagnostic_only_score_target_not_current_pass_gate`
- `wrong_wall_exit_rate_diagnostic`: `True` observed `0.10344827586206896` required `diagnostic_only_penalised_by_launch_score`
- `selected_primitive_family_count_diagnostic`: `True` observed `8` required `diagnostic_only_not_a_governor_pass_gate`
- `selected_variant_count_diagnostic`: `True` observed `99` required `diagnostic_only_not_a_governor_pass_gate`
...
- `r10_heavy_cluster_claim_profile_diagnostic`: `True` observed `{"case_claim_profile_passed": false, "claim_bearing_final_launch_count": 172, "floor_or_ceiling_violation_rate": 0.20930232558139536, "hard_failure_rate": 0.27906976744186046, "no_viable_primitive_rate": 0.09302325581395349, "safe_success_rate": 0.627906976744186, "terminal_or_lift_capture_rate": 0.627906976744186}` required `case_claim_rows>0; hard_failure<=0.2; floor_or_ceiling<=0.2; no_viable<=0.3; safe_success>=0.2; terminal_or_lift>=0.3`
- `r10_balanced_cluster_claim_profile_diagnostic`: `True` observed `{"case_claim_profile_passed": true, "claim_bearing_final_launch_count": 160, "floor_or_ceiling_violation_rate": 0.125, "hard_failure_rate": 0.175, "no_viable_primitive_rate": 0.1, "safe_success_rate": 0.725, "terminal_or_lift_capture_rate": 0.725}` required `case_claim_rows>0; hard_failure<=0.2; floor_or_ceiling<=0.2; no_viable<=0.3; safe_success>=0.2; terminal_or_lift>=0.3`
- `r10_light_cluster_claim_profile_diagnostic`: `True` observed `{"case_claim_profile_passed": true, "claim_bearing_final_launch_count": 160, "floor_or_ceiling_violation_rate": 0.15, "hard_failure_rate": 0.2, "no_viable_primitive_rate": 0.075, "safe_success_rate": 0.725, "terminal_or_lift_capture_rate": 0.725}` required `case_claim_rows>0; hard_failure<=0.2; floor_or_ceiling<=0.2; no_viable<=0.3; safe_success>=0.2; terminal_or_lift>=0.3`
- `r10_any_deployable_cluster_claim_profile_within_stage_profile`: `True` observed `balanced_cluster,light_cluster` required `any_of:heavy_cluster,balanced_cluster,light_cluster`
- `r10_learning_stage_uses_final_reject_rate_not_candidate_reject_rate`: `True` observed `0.08866995073891626` required `bounded_final_no_viable_rate_plus_tuning_handoff_diagnostics`
