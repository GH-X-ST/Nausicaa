...
- `hard_failure_rate_within_stage_profile`: `False` observed `0.207` required `0.2`
- `floor_or_ceiling_violation_rate_within_stage_profile`: `True` observed `0.187` required `0.2`
- `no_viable_primitive_rate_within_stage_profile`: `True` observed `0.065` required `0.3`
...
- `selected_variant_count_diagnostic`: `True` observed `237` required `diagnostic_only_not_a_governor_pass_gate`
...
- `r10_learning_stage_uses_final_reject_rate_not_candidate_reject_rate`: `True` observed `0.065` required `bounded_final_no_viable_rate_plus_tuning_handoff_diagnostics`
