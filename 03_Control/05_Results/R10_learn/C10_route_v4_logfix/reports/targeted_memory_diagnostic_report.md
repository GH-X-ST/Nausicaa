...
- Status: `complete`
- Pass gate: `False`
- Expected final held-out launches: `20`
- Expected history launches: `215`
...
- `final_heldout_launch_count`: `True` observed `20` required `20`
- `history_launch_count`: `True` observed `215` required `215`
...
- `selected_variant_count_diagnostic`: `True` observed `18` required `diagnostic_only_not_a_governor_pass_gate`
