...
def _docs_code_consistency_rows(repo_root: Path) -> list[dict[str, object]]:
    ...
    combined_requirements = {
        ...
        "r10_tunes_memory_shield_exploration_handoff": "R10 may tune memory sensitivity, memory-objective cap/confidence/tradeoff limits, reachable-flow attraction weight/cap, shield margins, exploration thresholds",
