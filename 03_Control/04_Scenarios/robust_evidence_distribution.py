...
from env_instance import (
    DEFAULT_FAN_POWER_SCALE_RANGE,
    DEFAULT_UPDRAFT_UNCERTAINTY_SCALE_RANGE,
    DEFAULT_UPDRAFT_WIDTH_SCALE_RANGE,
...
DEFAULT_RANDOM_POWER_SCALE_RANGE = DEFAULT_FAN_POWER_SCALE_RANGE
DEFAULT_RANDOM_WIDTH_SCALE_RANGE = DEFAULT_UPDRAFT_WIDTH_SCALE_RANGE
DEFAULT_RANDOM_UNCERTAINTY_SCALE_RANGE = DEFAULT_UPDRAFT_UNCERTAINTY_SCALE_RANGE
