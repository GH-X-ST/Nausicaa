...
R11_EXPECTED_FINAL_HELDOUT_LAUNCHES = len(LIBRARY_SIZE_CASE_IDS) * len(R11_POLICY_HISTORY_CONDITIONS) * R11_OUTER_CASES_PER_CONDITION
...
R11_PROTOCOL = ValidationProtocol(
    ...
    policy_history_conditions=R11_POLICY_HISTORY_CONDITIONS,
)
...
def _r11_protocol_for_outer_cases_per_ladder(outer_cases_per_ladder: int) -> ValidationProtocol:
    ...
    expected_final_heldout_launches = (
        len(LIBRARY_SIZE_CASE_IDS) * len(R11_POLICY_HISTORY_CONDITIONS) * outer_cases_per_condition
    )
