...
viconStateFilterEnabled = false;
viconStateFilterCutoffHz = NaN;
if isfield(runData.config, "viconStateFilterEnabled")
    viconStateFilterEnabled = logical(runData.config.viconStateFilterEnabled);
end
if isfield(runData.config, "viconStateFilterCutoffHz")
    viconStateFilterCutoffHz = double(runData.config.viconStateFilterCutoffHz);
end
...
result.analysisInfo = struct( ...
    ...
    "stateAngleField", "surface_angle_deg", ...
    "viconStateFilterEnabled", viconStateFilterEnabled, ...
    "viconStateFilterCutoffHz", viconStateFilterCutoffHz);
result.outputFiles = struct( ...
