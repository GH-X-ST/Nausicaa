...
for eventIndex = 1:height(events)
    ...
    holdRows = [holdRows; table( ... %#ok<AGROW>
        ...
        'direction_group', 'scheduled_start_s', 'scheduled_end_s', 'settled_deflection_deg', ...
        'settled_std_deg', 'valid', 'rejection_reason'})];
end
...
for surfaceIndex = 1:numel(surfaceNames)
    ...
    implementationError = [implementationError; table( ... %#ok<AGROW>
        ...
        surfaceRows.command_level_norm, surfaceRows.direction_group, surfaceRows.delta_rel_deg, fittedDeg, errorDeg, ...
        surfaceRows.valid, surfaceRows.rejection_reason, ...
        'VariableNames', {'event_id', 'surface_index', 'surface_name', 'command_level_norm', ...
        'direction_group', 'settled_deflection_deg', 'fitted_deflection_deg', ...
        'implementation_error_deg', 'valid', 'rejection_reason'})];
    ...
    surfaceTable = [surfaceTable; table( ... %#ok<AGROW>
        ...
        estimateHysteresis(validRows), estimateRepeatability(validRows), ...
        ...
        'hysteresis_deg', 'repeatability_std_deg', 'fit_rmse_deg', ...
